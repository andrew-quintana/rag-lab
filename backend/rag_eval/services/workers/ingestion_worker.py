...
from rag_eval.services.workers.pdf_utils import (
    get_pdf_page_count,
    slice_pdf_to_batch,
    generate_page_batches,
)
from rag_eval.services.rag.ingestion import extract_text_from_batch
from rag_eval.services.rag.storage import download_document_from_blob
from rag_eval.services.rag.supabase_storage import download_document_from_storage
...
def ingestion_worker(queue_message: dict, context: Optional[Any] = None) -> None:
    ...
    try:
        ...
        for batch_index, (start_page, end_page) in enumerate(batch_ranges):
            ...
            # Process batch if not completed
