...
def enqueue_message(queue_name: str, message: QueueMessage, config) -> None:
    ...
    Note:
        Messages are base64 encoded for Azure Functions queue triggers.
        Azure Functions expects base64-encoded strings for queue messages.
    """
    try:
        import base64
        ...
        # Send message as plain text string
        # Azure Functions Python queue triggers with dataType="string" expect plain text
