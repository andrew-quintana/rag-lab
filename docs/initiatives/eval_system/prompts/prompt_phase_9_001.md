...
**Related Documents:**
- @docs/initiatives/eval_system/scoping/PRD001.md - Product requirements (FR7: BEIR-Style Retrieval Metrics)
- @docs/initiatives/eval_system/scoping/RFC001.md - Technical design (Phase 8: BEIR Metrics Evaluator, Interface Contracts)
- @docs/initiatives/eval_system/scoping/TODO001.md - Implementation tasks (Phase 9 section - check off tasks as completed)
...
- **REQUIRED**: Check off completed tasks in @docs/initiatives/eval_system/scoping/TODO001.md Phase 9 section as you complete them
