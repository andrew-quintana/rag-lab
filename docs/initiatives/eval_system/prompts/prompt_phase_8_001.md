...
**Related Documents:**
- @docs/initiatives/eval_system/scoping/PRD001.md - Product requirements (FR6: Meta-Evaluator)
- @docs/initiatives/eval_system/scoping/RFC001.md - Technical design (Phase 7: Meta-Evaluator, Interface Contracts)
- @docs/initiatives/eval_system/scoping/TODO001.md - Implementation tasks (Phase 8 section - check off tasks as completed)
...
- **REQUIRED**: Check off completed tasks in @docs/initiatives/eval_system/scoping/TODO001.md Phase 8 section as you complete them
