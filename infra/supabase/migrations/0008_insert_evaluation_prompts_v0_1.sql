-- Migration: Insert evaluation prompts into prompts table with new schema
-- This migration inserts the three evaluation prompt templates with:
-- - Table: prompts (renamed from prompt_versions)
-- - id: UUID (auto-generated)
-- - version: 0.1 (semantic versioning, no "v" prefix)
-- - name: evaluator name (renamed from evaluator_type)
