...
**Related Documents:**
- @docs/initiatives/eval_system/scoping/PRD001.md - Product requirements
- @docs/initiatives/eval_system/scoping/RFC001.md - Technical design (Decision 5: Base Evaluator Class Pattern)
- @docs/initiatives/eval_system/scoping/TODO001.md - Implementation tasks (Phase 3.5 section - check off tasks as completed)
...
- **REQUIRED**: Check off completed tasks in @docs/initiatives/eval_system/scoping/TODO001.md Phase 3.5 section as you complete them
