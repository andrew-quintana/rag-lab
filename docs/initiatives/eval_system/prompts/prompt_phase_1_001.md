...
**Related Documents:**
- @docs/initiatives/eval_system/scoping/PRD001.md - Product requirements (FR8: Evaluation Dataset Construction)
- @docs/initiatives/eval_system/scoping/RFC001.md - Technical design (Phase 1: Evaluation Dataset Construction)
- @docs/initiatives/eval_system/scoping/TODO001.md - Implementation tasks (Phase 1 section - check off tasks as completed)
...
- **REQUIRED**: Check off completed tasks in @docs/initiatives/eval_system/scoping/TODO001.md Phase 1 section as you complete them
